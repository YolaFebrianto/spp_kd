      ...
      <div class="page-header min-vh-100">
        <div class="container">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  <h4 class="font-weight-bolder">SISWA | Login</h4>
                  <p class="mb-0">Masukkan NIS dan Password</p>
                  <p class="mb-0"><?php echo $this->session->flashdata('msg');?></p>
                  <?php if ($this->session->flashdata('failed')) { ?>
                  <p class="mb-0" style="color:red;"><i class="fa fa-close"></i> NIS atau Password salah!</p>
                  <?php  }  ?>
                </div>
                <div class="card-body">
                  <?php echo form_open('student/auth/login', array('class'=>'login100-form validate-form','role'=>'form')); ?>
                    <div class="mb-3">
                      <input type="number" name="nis" class="form-control form-control-lg" placeholder="Masukkan NIS" aria-label="NIS" min="1">
                    </div>
                    <div class="mb-3">
          ...
          background-size: cover;">
                ...
                <h4 class="mt-5 text-white font-weight-bolder position-relative">SPPS APP</h4>
                <p class="text-white position-relative">Sistem Pembayaran Pendidikan Sekolah</p>
              </div>
            </div>
          </div>
        </div>
