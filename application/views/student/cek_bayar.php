			...
			<div class="card-body">
				...
				<div class="form-group" style="margin-bottom:0;">
					<div class="row" style="margin-bottom:0;">
						...
						<div class="col-sm-4 col-lg-2 col-md-2">
							<input type="text" autofocus name="r" <?php echo (isset($f['r'])) ? 'placeholder="'.$f['r'].'"' : 'placeholder="NIS Siswa"' ?> class="form-control" required value="<?php echo @$this->session->userdata('unis_student'); ?>" readonly>
						</div>
